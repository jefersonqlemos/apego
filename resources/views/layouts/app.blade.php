...
<head>
    ...
    <link rel="shortcut icon" sizes="16x16" type="image/png" href="{{ asset('img/favicon16x16.png') }}">

    <link rel="shortcut icon" sizes="32x32" type="image/png" href="{{ asset('img/favicon32x32.png') }}">

    <link rel="shortcut icon" sizes="64x64" type="image/png" href="{{ asset('img/favicon64x64.png') }}">
